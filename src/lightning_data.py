...
def _worker_init_use_file_system(_worker_id):
    """Use filesystem instead of /dev/shm for tensor sharing in this worker (avoids bus error when shm is small)."""
    try:
...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        self._train_dataloader = DataLoader(
            ...
            sampler=sampler,
            worker_init_fn=_worker_init_use_file_system,
            pin_memory=False,  # reduces memory/shm pressure when using many workers
        )
